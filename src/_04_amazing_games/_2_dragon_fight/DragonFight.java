...
playerHealth = playerHealth - dragonAttack;
	...
	JOptionPane.showMessageDialog(null,"The dragon has "+dragonHealth+" left.");
			...
			// round)
	JOptionPane.showMessageDialog(null,"You lost "+dragonAttack+" health.");
	JOptionPane.showMessageDialog(null,"The dragon lost "+playerAttack+" health.");
	...
	static void dragonLost() {
		...
		JOptionPane.showMessageDialog(null,"You defeated the dragon and got a treasure chest full of gold!");
		System.exit(0);   //This code ends the program
	}
